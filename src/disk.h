...
extern char *RAW_MAP[RAW_MAP_MAX_NUMBER];
extern char *RAW_MAP_ORDERED[RAW_MAP_MAX_NUMBER];
extern ALLEGRO_BITMAP *RAW_TEXTURE[RAW_TEXTURE_MAX_NUMBER];
extern ALLEGRO_BITMAP *RAW_MAPTEX[RAW_TEXTURE_MAX_NUMBER];
